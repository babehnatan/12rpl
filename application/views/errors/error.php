...
>
  <head>
    ...
    <title><?=$admin->nama_perusahaan?></title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="<?=base_url()?>images/<?=$admin->favicon?>" />
    ...
    <link rel='stylesheet' href='<?=site_url()?>/assets/toastr/toastr.min.css' />
  ...
  <body style="text-align:center">
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <a href="<?=site_url();?>dashboard?m=dashboard&token=<?=hash ( "sha256", 'dashboard' )?>" class="btn btn-primary">Back to home</a>
        <div class="mt-3">
          <img
