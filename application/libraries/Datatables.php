  ...
  class Datatables
  {
    ...
    */
    private function get_filtering()
    {
      ...
      $sSearch = $this->ci->db->escape_like_str(trim(isset($search['value']) === 'true' ? true:false )) ;
      // isset($db['email']) == $email ? '' : '|is_unique[user.email]';
    ...
    */
    private function check_cType()
    {
      ...
      if(is_numeric(isset($column[0]['data']) === 'true' ? true:false))
        return FALSE;
      else
        return TRUE;
    }
